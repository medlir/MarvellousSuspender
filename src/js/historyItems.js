...
export const historyItems = (() => {
  ...
  async function createSessionHtml(session, showLinks) {
    ...
    const windowRestore = createEl('a',     { class: 'groupLink restoreLink',   href: '#', }, gsUtils.getMessage('js_history_restore'));
  ...
  function createWindowHtml(index, showLinks) {
    ...
    groupRestore = createEl('a',              { class: 'groupLink restoreLink',         href: '#main-div-' + index }, gsUtils.getMessage('js_history_restore'));
